  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='flex flex-col md:flex-row'>
        {/* Left Column - Images */}
        <div className='w-full md:w-1/2 bg-neutral-200 dark:bg-gray-800 relative'>
          ...
          <div className='h-screen relative'>
            ...
            <div className='absolute top-24 left-6 md:left-24 max-w-xs'>
              <div className='bg-white dark:bg-gray-700 bg-opacity-90 p-5 rounded-2xl'>
            ...
            <div className='absolute bottom-6 left-6 flex items-center'>
              <div className='rounded-full overflow-hidden w-16 h-16 border-2 border-white dark:border-gray-600'>
                <img
        ...
        <div className='w-full md:w-1/2 bg-pink-100 dark:bg-gray-900 flex items-center justify-center p-8'>
          <div className='max-w-md mx-auto text-center'>
            <h1 className='text-4xl md:text-6xl font-bold text-red-700 dark:text-red-400 mb-8'>
              See it, make it, try it, do it
            </h1>
            <p className='text-xl md:text-2xl text-red-700 dark:text-red-300 mb-10'>
