      ...
      <div className='relative w-full max-w-96 flex flex-col gap-4 py-8 px-10 bg-white rounded-2xl shadow-md mx-4'>
        ...
        <div className='flex flex-col gap-3'>
          ...
          <button
            onClick={googleLogin}
            type='button'
            className='py-2 px-4 rounded-full bg-white border-2 border-gray-300 text-gray-700 text-base font-semibold hover:bg-gray-50 transition-all cursor-pointer flex items-center justify-center gap-3'
          >
          ...
          <button
            onClick={githubLogin}
            type='button'
            className='py-2 px-4 rounded-full bg-gray-900 text-white text-base font-semibold hover:bg-gray-800 transition-all cursor-pointer flex items-center justify-center gap-3'
          >
